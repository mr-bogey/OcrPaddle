...
USE_LITE_KERNEL(silu, kARM, kFloat, kNCHW, def);

USE_LITE_KERNEL(gru, kARM, kFloat, kNCHW, def);

USE_LITE_KERNEL(gru, kARM, kInt8, kNCHW, def);

USE_LITE_KERNEL(reduce_mean, kARM, kFloat, kNCHW, i64);

USE_LITE_KERNEL(reduce_mean, kARM, kFloat, kNCHW, i32);
...
USE_LITE_KERNEL(reduce_max, kARM, kFloat, kNCHW, i32);

USE_LITE_KERNEL(reduce_min, kARM, kFloat, kNCHW, def);

USE_LITE_KERNEL(reduce_min, kARM, kFloat, kNCHW, i64);

USE_LITE_KERNEL(reduce_min, kARM, kFloat, kNCHW, i32);

USE_LITE_KERNEL(reduce_sum, kARM, kFloat, kNCHW, def);

USE_LITE_KERNEL(reduce_sum, kARM, kFloat, kNCHW, i64);

USE_LITE_KERNEL(reduce_sum, kARM, kFloat, kNCHW, i32);

USE_LITE_KERNEL(reduce_prod, kARM, kFloat, kNCHW, def);

USE_LITE_KERNEL(reduce_prod, kARM, kFloat, kNCHW, i64);

USE_LITE_KERNEL(reduce_prod, kARM, kFloat, kNCHW, i32);
...
USE_LITE_KERNEL(fused_attention, kARM, kInt8, kNCHW, def);
...
USE_LITE_KERNEL(calib, kARM, kFloat, kNCHW, int32_to_fp32);

USE_LITE_KERNEL(calib, kARM, kFloat, kNCHW, int32_to_int64);

USE_LITE_KERNEL(calib, kARM, kFloat, kNCHW, fp32_to_int32);

USE_LITE_KERNEL(calib, kARM, kFloat, kNCHW, int64_to_fp32);

USE_LITE_KERNEL(calib, kARM, kFloat, kNCHW, fp32_to_int64);

USE_LITE_KERNEL(calib, kARM, kInt8, kNCHW, int8_to_fp32);

USE_LITE_KERNEL(calib, kARM, kFloat, kNCHW, int64_to_int32);

USE_LITE_KERNEL(calib, kARM, kFloat, kNCHW, bool_to_float);

USE_LITE_KERNEL(calib_once, kARM, kInt8, kNCHW, fp32_to_int8);

USE_LITE_KERNEL(calib_once, kARM, kInt8, kNCHW, int8_to_fp32);

USE_LITE_KERNEL(calib_once, kARM, kFloat, kNCHW, int64_to_int32);
...
USE_LITE_KERNEL(viterbi_decode, kARM, kFloat, kNCHW, def);
...
USE_LITE_KERNEL(fusion_elementwise_mul_activation, kARM, kFloat, kNCHW, int64);
...
USE_LITE_KERNEL(elementwise_div, kARM, kFloat, kNCHW, int32);

USE_LITE_KERNEL(elementwise_div, kARM, kFloat, kNCHW, int64);
...
USE_LITE_KERNEL(elementwise_mod, kARM, kFloat, kNCHW, int32);

USE_LITE_KERNEL(elementwise_pow, kARM, kFloat, kNCHW, def);

USE_LITE_KERNEL(elementwise_pow, kARM, kFloat, kNCHW, int32);

USE_LITE_KERNEL(elementwise_floordiv, kARM, kFloat, kNCHW, int32);
...
USE_LITE_KERNEL(pixel_unshuffle, kHost, kFloat, kNCHW, def);
