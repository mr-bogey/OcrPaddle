    ...
    namespace lite {
        namespace utils {
            namespace cv {
                ...
                // color enum
                enum ImageFormat {
                    RGBA = 0, BGRA, RGB, BGR, GRAY, NV21 = 11, NV12, YUV420SP, YUV420P, YUV422, YUV444
                };
                // flip enum
                enum FlipParam {
                ...
                public:
                    ...
                    * BGRA(RGBA)
                    */
                    void image_convert(const uint8_t *src, uint8_t *dst, ImageFormat srcFormat, ImageFormat dstFormat);
                    ...
                    */
                    void image_convert(const uint8_t *src, uint8_t *dst, ImageFormat srcFormat, ImageFormat dstFormat, int srcw, int srch);
                    ...
                    */
                    void image_rotate(const uint8_t *src, uint8_t *dst, ImageFormat srcFormat, int srcw, int srch, float degree);
                    ...
                    */
                    void image_flip(const uint8_t *src, uint8_t *dst, ImageFormat srcFormat, int srcw, int srch, FlipParam flip_param);
                    ...
                    */
                    void image_to_tensor(const uint8_t *src, Tensor *dstTensor, LayoutType layout, float *means, float *scales);
                    ...
                    * param scales: scales of image
                    */
                    void image_to_tensor(const uint8_t *src, Tensor *dstTensor, ImageFormat srcFormat, int srcw, int srch, LayoutType layout, float *means, float *scales);
