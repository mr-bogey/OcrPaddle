 ...
 */
    ...
    public:
         ...
         * @return
         */
        virtual std::vector<OCRPredictResult> infer_ocr(cv::Mat &origin,int max_size_len, int run_det,int run_cls, int run_rec);
    ...
    private:
        ...
        void infer_det(cv::Mat &origin, int max_side_len,std::vector<OCRPredictResult> &ocr_results);
         ...
         * @return
         */
        void infer_rec(const cv::Mat &origin, int run_cls,OCRPredictResult &ocr_result);
